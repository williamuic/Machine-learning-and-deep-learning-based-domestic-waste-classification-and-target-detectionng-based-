...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--task', default='layout',
                                help='layout')
        self.parser.add_argument('--dataset', default='layout',
                                 help='coco | pascal | layout')
        self.parser.add_argument('--exp_id', default='default')
        # action 只要运行该变量就设为True
        self.parser.add_argument('--test', action='store_true')

        self.parser.add_argument('--debug', type=int, default=1)

        self.parser.add_argument('--draw', action='store_true',)
        self.parser.add_argument('--resize', default=3)
        ...
        self.parser.add_argument('--corner_hm_weight', type=float, default=1,
        ...
        self.parser.add_argument('--center_thresh', type=float, default=0.2,
    ...
    def update_dataset_info_and_set_heads(self, opt, dataset):
        ...
        opt.heads = {'corner_hm': 4, 'center_hm': opt.num_classes,
                         'wh': 2, 'off': 2}
